...
export const PROJECTS: Project[] = [
  ...
  // Removed duplicate AC Combiner Panel and Schneider Switchgear entries
  {
    ...
    year: '2021',
    location: 'Anambra',
    imageUrl: '/800 dual ats panel.PNG',
  },
  {
    title: '1600A ATS Panel',
    category: 'Distribution & Transfer Panels',
    year: '2022',
    location: 'Lagos',
    imageUrl: '/1600 ats panel.PNG',
  },
  {
    ...
    year: '2023',
    location: 'Ogun',
    imageUrl: '/ac combiner panel.PNG',
  },
  {
  ...
  },
  {
    ...
    year: '2022',
    location: 'Lagos',
    imageUrl: '/schneider switchgear.PNG',
  },
  {
